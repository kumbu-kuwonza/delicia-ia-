  ...
  try {
    ...
    if (!isAutomationEnabled()) {
      ...
      return {
        ...
        customer: processCustomerData(orderData.customer, orderData.payment.total)
      };
    }
    ...
    const processedCustomer = processCustomerData(orderData.customer, orderData.payment.total);
...
const processCustomerData = (customerData: OrderCustomer, orderTotal: number): Customer => {
